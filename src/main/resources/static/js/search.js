    ...
    var vm = new Vue({
        ...
        methods: {
            save: function (count, houses) {
                axios.post("http://localhost:8888/houses/" + count, houses).then((resp) => {
        ...
        mounted: function () {
            axios.post("http://localhost:8888/houses/" + this.pageCount, this.houses).then((resp) => {
                this.pages = resp.data
                // console.log("------");
                // console.log(this.pages);
            })
